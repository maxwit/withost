...
ALTER TABLE TBL_BUDDY
	ADD CONSTRAINT FOREIGN KEY (i_id)
		REFERENCES TBL_USER (id)
		ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE TBL_BUDDY
	ADD  CONSTRAINT FOREIGN KEY (u_id)
		REFERENCES TBL_USER (id)
		ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE TBL_COURSE_DEPEND
	ADD CONSTRAINT FOREIGN KEY (source_id)
		REFERENCES TBL_COURSE (id)
		ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE TBL_COURSE_DEPEND
	ADD CONSTRAINT FOREIGN KEY (depend_id)
		REFERENCES TBL_COURSE (id)
		ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE TBL_COURSE_IMPROVE
	ADD CONSTRAINT FOREIGN KEY (improve_id)
		REFERENCES TBL_COURSE (id)
		ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE TBL_COURSE_SUITE
	ADD CONSTRAINT FOREIGN KEY (suite_id)
